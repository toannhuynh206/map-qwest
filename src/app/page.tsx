...
const QUIZZES = [
  {
    ...
    description: 'A country is called — find it on the world map',
    icon: '📍',
    href: '/play/quiz',
    available: true,
    accent: '#58CC02',
  },
  {
    id: 'us-states',
    title: '50 States',
    description: 'Name a state, pin it on the US map',
    icon: '🦅',
    href: '/play/states',
    available: true,
    accent: '#007AFF',
  },
  {
    ...
    description: 'A flag appears — which country flies it?',
    icon: '🚩',
    href: '/play/flags',
    available: true,
    accent: '#FF9500',
  },
  {
    ...
    description: 'Name every country you know, against the clock',
    icon: '⌨️',
    href: '/play/typing',
    available: true,
    accent: '#007AFF',
  },
  {
    id: 'geography-quiz',
    title: 'Mixed Quiz',
    description: 'Flags, borders & continents — 10, 20, or 25 questions',
    icon: '🧠',
    href: '/play/mixed',
    available: true,
    accent: '#AF52DE',
  },
  {
    id: 'puzzle',
    title: 'Daily Puzzle',
    description: '6 questions, once a day — streak on the line',
    icon: '🧩',
    href: '/play/puzzle',
    available: true,
    accent: '#FF9500',
  },
  {
    id: 'globe-quiz',
    title: 'Globe Quiz',
    description: 'Spin the globe and pin the country — the world in your hands',
    icon: '🌐',
    href: '/play/globe',
    available: true,
    accent: '#1A6BAA',
...
const LEARNING = [
  {
    id: 'story-mode',
    title: 'Story Mode',
    description: 'Explore each continent through stories and a map',
    icon: '📖',
    href: '/learn',
    available: true,
    accent: '#58CC02',
  },
  {
    id: 'flag-flashcards',
    title: 'Flag Cards',
    description: 'Flip through 195 flags — see how many you know',
    icon: '🚩',
    href: '/learn/flags',
    available: true,
    accent: '#FF9500',
  },
  {
    ...
    description: 'A country is named — find it or tap Give Up to see it',
    icon: '📌',
    href: '/learn/map-pin',
    available: true,
    accent: '#007AFF',
  ...
  },
  {
    id: 'smart-review',
    title: 'Smart Review',
    description: 'Spaced repetition — hard ones come back sooner',
    icon: '🃏',
    href: '/learn',
    available: false,
    accent: '#AF52DE',
